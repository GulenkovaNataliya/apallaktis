export const messages = {
  el: {
    landing: {
      ...
      viewPricing: "Δείτε τα τιμολόγια",
    ...
    pricing: {
      ...
      unlimitedReferral: "Απεριόριστο Referral Program",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Εξαγωγή Excel",
          "Εξαγωγή PDF",
          "Απεριόριστο Referral Program: Bonus 1 μήνα δωρεάν",
  ...
  ru: {
    ...
    pricing: {
      ...
      unlimitedReferral: "Безлимитная Referral Program",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Экспорт Excel",
          "Экспорт PDF",
          "Безлимитная Referral Program: Bonus 1 месяц бесплатно",
  ...
  uk: {
    ...
    pricing: {
      ...
      unlimitedReferral: "Безлімітна Referral Program",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Експорт Excel",
          "Експорт PDF",
          "Безлімітна Referral Program: Bonus 1 місяць безкоштовно",
  ...
  sq: {
    landing: {
      ...
      viewPricing: "Shihni tarifat",
      howToUse: "Si të përdorni",
    },
    pricing: {
      title: "Tarifat",
      back: "← Prapa",
      ...
      unlimitedReferral: "Referral Program i pakufizuar",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Eksport Excel",
          "Eksport PDF",
          "Referral Program i pakufizuar: Bonus 1 muaj falas",
  ...
  bg: {
    ...
    pricing: {
      ...
      excelExport: "Експорт Excel",
      pdfExport: "Експорт PDF",
      unlimitedReferral: "Неограничена Referral Program",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Експорт Excel",
          "Експорт PDF",
          "Неограничена Referral Program: Bonus 1 месец безплатно",
  ...
  ro: {
    landing: {
      ...
      viewPricing: "Vedeți tarifele",
      howToUse: "Cum să utilizați",
    },
    pricing: {
      title: "Tarife",
      back: "← Înapoi",
      ...
      unlimitedReferral: "Referral Program nelimitat",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Export Excel",
          "Export PDF",
          "Referral Program nelimitată: Bonus 1 lună gratuită",
  ...
  ar: {
    ...
    pricing: {
      ...
      pdfExport: "PDF تصدير",
      unlimitedReferral: "Referral Program غير محدود",
    ...
    subscription: {
      ...
      basic: {
        ...
        features: [
          ...
          "Excel تصدير",
          "PDF تصدير",
          "Referral Program غير محدود: Bonus شهر واحد مجانا",
