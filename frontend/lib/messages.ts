export const messages = {
  el: {
    ...
    finance: {
      ...
      paymentReceived: "Πληρωμή Εισπράχθηκε",
      expensesPaid: "Έξοδα Πληρώθηκαν",
  ...
  sq: {
    ...
    finance: {
      ...
      paymentReceived: "Pagesa e Marrë",
      expensesPaid: "Shpenzimet e Paguara",
  ...
  bg: {
    ...
    finance: {
      ...
      paymentReceived: "Плащане Получено",
      expensesPaid: "Разходи Платени",
  ...
  ro: {
    ...
    finance: {
      ...
      expensesPaid: "Cheltuieli Plătite",
