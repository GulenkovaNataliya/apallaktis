export const messages = {
  el: {
    ...
    login: {
      ...
      emailNotConfirmed: "Παρακαλώ επιβεβαιώστε το email και το τηλέφωνό σας. Ελέγξτε τα εισερχόμενά σας.",
  ...
  ru: {
    ...
    login: {
      ...
      emailNotConfirmed: "Пожалуйста, подтвердите email и телефон. Проверьте вашу почту.",
  ...
  uk: {
    ...
    login: {
      ...
      emailNotConfirmed: "Будь ласка, підтвердіть email та телефон. Перевірте вашу пошту.",
  ...
  sq: {
    ...
    login: {
      ...
      emailNotConfirmed: "Ju lutemi konfirmoni email-in dhe telefonin tuaj. Kontrolloni mesazhet tuaja.",
  ...
  bg: {
    ...
    login: {
      ...
      emailNotConfirmed: "Моля, потвърдете email и телефон. Проверете пощата си.",
  ...
  ro: {
    ...
    login: {
      ...
      emailNotConfirmed: "Vă rugăm confirmați email-ul și telefonul. Verificați căsuța de e-mail.",
  ...
  en: {
    ...
    login: {
      ...
      emailNotConfirmed: "Please confirm your email and phone. Check your inbox.",
  ...
  ar: {
    ...
    login: {
      ...
      emailNotConfirmed: "الرجاء تأكيد البريد الإلكتروني والهاتف. تحقق من صندوق الوارد الخاص بك.",
