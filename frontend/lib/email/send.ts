...
function generateAccountPurchaseEmailHTML(accountNumber: number, locale: string): string {
  const texts = {
    el: {
      ...
      freeMonth: '🎁 Ο πρώτος μήνας είναι ΔΩΡΕΑΝ!',
    ...
    uk: {
      ...
      freeMonth: '🎁 Перший місяць БЕЗКОШТОВНО!',
    ...
    sq: {
      ...
      freeMonth: '🎁 Muaji i parë është FALAS!',
    ...
    bg: {
      ...
      freeMonth: '🎁 Първият месец е БЕЗПЛАТЕН!',
    ...
    ro: {
      ...
      freeMonth: '🎁 Prima lună este GRATUITĂ!',
